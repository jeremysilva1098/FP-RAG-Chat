...
// create the interface for a chat message
...
export async function sendMessage(sessionObj: freeplay.ChatSession, message: string) {
...
export async function getCompletion(message: string) {
    ...
    }) as freeplay.ChatCompletionResponse;
